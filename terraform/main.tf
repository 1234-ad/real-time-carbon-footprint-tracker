# Terraform configuration for Carbon Footprint Tracker infrastructure
...
resource "aws_db_instance" "main" {
  ...
  password = "carbon_password_${random_password.db_password.result}"
...
resource "aws_elasticache_replication_group" "main" {
  ...
  description                = "Redis cluster for Carbon Tracker"
...
resource "aws_security_group" "kafka" {
  name_prefix = "${local.cluster_name}-kafka-"
  vpc_id      = aws_vpc.main.id
...
resource "aws_kms_key" "main" {
  description             = "KMS key for Carbon Tracker encryption"
